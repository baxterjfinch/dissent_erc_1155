...
contract ERC20Interface {
  ...
  contract MarketPlaceStorage {
      ...
      uint256 public ownerCutPerMillion = 900000;
  ...
  contract Marketplace is Migratable, Ownable, MarketPlaceStorage {
      using SafeMath for uint256;
      using AddressUtils for address;

      constructor(address _acceptedtoken, address _owner) {
          // public isInitializer("Atlas Marketplace", "0.0.1");
        ...
        function _cancelOrder(address nftAddress, uint256 assetId) internal returns (Order) {
          ...
          function _executeOrder(
             ...
             internal returns (Order)
            {
              ...
              //   require(
              //     acceptedToken.transferFrom(msg.sender, owner, ownerCut),
